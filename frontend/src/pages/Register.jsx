        ...
        <div className="relative z-20 max-w-2xl w-full">
          ...
          >
            <p className="text-xl lg:text-3xl text-slate-300 font-light tracking-wide">
              Start your journey with <span className="text-cyan-400 font-medium glow-cyan">AI Precision</span>
            </p>
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-6 lg:p-12 relative z-20 bg-[#020617]/50 lg:bg-transparent min-h-[600px] lg:min-h-screen order-2 lg:order-2">
        ...
        >
          ...
          <div className="glass-card p-8 sm:p-10 shadow-2xl border border-white/10 backdrop-blur-2xl relative overflow-hidden group hover:border-indigo-500/30 transition-all duration-500">
            ...
            {/* Top Glow */}
            <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[200px] h-[200px] bg-purple-500/20 blur-[80px] pointer-events-none group-hover:bg-purple-500/30 transition-all duration-500" />

            <div className="relative z-10">
              <div className="mb-6">
                <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Create Account</h2>
                <p className="text-slate-400">Join thousands of professionals enhancing their career</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="group/input">
                  <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">Full Name</label>
                  <div className="relative">
                    <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500 group-focus-within/input:text-indigo-400 transition-colors" />
                    <input
                      type="text"
                      value={formData.name}
                ...
                {/* Password Field */}
                <div className="group/input">
                  <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">Password</label>
                  <div className="relative">
                ...
                <div className="group/input">
                  <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">Confirm Password</label>
                  <div className="relative">
                    <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500 group-focus-within/input:text-indigo-400 transition-colors" />
                    <input
                      type="password"
                ...
                {/* College Fields Group */}
                <div className="space-y-4">
                  <div className="group/input">
                    <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">College / University</label>
                    <input
                      type="text"
                      value={formData.college}
                      onChange={(e) => setFormData({ ...formData, college: e.target.value })}
                      className="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500/50 focus:bg-white/10 focus:ring-1 focus:ring-indigo-500/50 transition-all duration-300"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="group/input">
                      <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">Degree</label>
                      <input
                        type="text"
                    ...
                    <div className="group/input">
                      <label className="block text-sm font-medium text-slate-300 mb-1.5 group-focus-within/input:text-indigo-400 transition-colors">Graduation Year</label>
                      <input
                        type="number"
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 focus:ring-2 focus:ring-purple-500/30 shadow-lg shadow-indigo-500/20 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden relative group/btn mt-2"
                >
              ...
              <p className="text-center text-sm text-slate-400 mt-6">
                ...
                <Link to="/" className="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors hover:underline underline-offset-4">
                  Sign in
                </Link>
              </p>
            </div>
